	...
	<body>
		...
		<div class="row">
			...
			<form action="index.php" method="post">
			    ...
			    <div id="name"><input type="text" name="namef" placeholder="First"><input type="text" name="namem" size="2" placeholder="M"><input type="text" name="namel" placeholder="Last"></div>
				...
				<label for="food">Favorite Food</label><input id="food" type="text" name="food">
				<br>
